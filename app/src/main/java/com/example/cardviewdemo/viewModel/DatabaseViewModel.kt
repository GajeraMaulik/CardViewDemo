...
class DatabaseViewModel : ViewModel(){
    ...
    fun addChatDb(currentUserId: String?,receiverId : String?, message: String?, timestamp: Long?, channelid:String,totalmessage:Int) {
        successAddChatDb = instance?.addChatsInDatabase(currentUserId!!, receiverId!!, message!!, timestamp!!, channelid,totalmessage)
    }
